...
- Hand class will cover a player or dealer's hand, with current hand totals, associated bets, and associated insurance.
- Bank class will handle the account balances.
- Blackjack class will cover the game rules, and the settling of bets.
